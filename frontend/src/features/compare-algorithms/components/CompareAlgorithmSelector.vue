  ...
  <div class="flex items-center gap-4 p-4 rounded-2xl"
    ...
    <div class="flex-1">
      ...
      <select
        ...
        @change="onLeftChange"
        class="w-full px-3 py-2 rounded-xl text-sm font-medium text-text-primary border transition-colors cursor-pointer"
...
const onLeftChange = (e: Event) => { store.leftAlgorithmId = (e.target as HTMLSelectElement).value; };
const onRightChange = (e: Event) => { store.rightAlgorithmId = (e.target as HTMLSelectElement).value; };
